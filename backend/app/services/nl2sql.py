...
6. Be aware of MySQL-specific features like AUTO_INCREMENT"""
            ...
            db_name = "SQLite"
            syntax_rules = """3. Use double quotes for identifiers (e.g., "table_name", "column_name")
4. Return valid SQLite syntax
5. Use SQLite LIMIT syntax (LIMIT n)
6. SQLite doesn't support JOIN without ON, use simple joins"""
        else:
            db_name = "PostgreSQL"
